...
root, as determined by the sign of $(1-2p)$. This can be explained by Property
3 in Section \ref{sec:p3}: When $p \to 0$, the binomial skews left and
converges toward the positive half normal, which by
...
must conclude the latter, which brings us back to the familiar normal
approximation.
