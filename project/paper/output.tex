...
Figure \ref{fig:sn-restriction-p-range} in appendix \ref{app:graphs} shows this
range as a function of $n$, this interval grows quickly as $n$ increases, and
for sufficiently large $n$, it becomes almost $(0, 1)$. For example, when
...
%\begin{figure}
%  \centering
%  \subfloat{\label{fig:mabs-n25}\includegraphics[width=0.8\textwidth]{../images/mabs-n25.png}}                
%  \\ \vspace{5mm}
%  \subfloat{\label{fig:mabs-n100}\includegraphics[width=0.8\textwidth]{../images/mabs-n100.png}}
%  \caption{MABS as a function of p}
%  \label{fig:mabs-fixed-n}
%\end{figure}
%
%\begin{figure}
%  \centering
%  \subfloat{\label{fig:mabs-p0.05}\includegraphics[width=0.8\textwidth]{../images/mabs-p005.png}}                
%  \\ \vspace{5mm}
%  \subfloat{\label{fig:mabs-p0.1}\includegraphics[width=0.8\textwidth]{../images/mabs-p01.png}}
%  \caption{MABS as a function of n}
%  \label{fig:mabs-fixed-p}
%\end{figure}
